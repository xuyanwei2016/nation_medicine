<!-- 电子书设置 -->
<template>
  <div class="setting-wrap epidemic">
    ...
    <div class="opt-list">
      <el-form ref="sizeForm" :model="sizeForm" label-width="80px" size="mini">
        ...
        <el-form-item size="small">
          <el-button type="primary" @click="submitForm('sizeForm')" style="background: #18ADB8;border-color: #18ADB8">保存</el-button>
