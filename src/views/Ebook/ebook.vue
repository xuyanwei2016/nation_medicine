  ...
  export default {
    ...
    methods: {
      ...
      handleSettingCallback(callbackPrams) {
        ...
        // 字体大小
        if (data.fontSize) {
          console.log(data.fontSize,887799);
      ...
      handleChapterChange(callbackPrams) {
        console.log(callbackPrams,'aaaa');
      ...
      getRelationResourceDetails(obj) {
        getRelationResourceDetailsAPI(obj).then(res => {
          if(res.data.code == 0) {
            ...
            console.log(this.nationsType,'667788');
      ...
      handlePageChange(type) {
        ...
        this.getEbookContent(null, orderNum)
      },
    ...
    created() {
      console.log(this.$route.query.bookid,'oooo');
